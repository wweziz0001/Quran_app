...
هذا الدليل يشرح منهجية التوثيق وإدارة الإصدارات في مشروع Quran Application. عند العمل على هذا المشروع، يجب اتباع هذه التعليمات بدقة لضمان الاتساق والجودة.
...
git push https://<TOKEN>@github.com/wweziz0001/Quran_app.git v1.2.6
```
